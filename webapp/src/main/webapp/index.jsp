...
<title>Bhumi Science & Tech</title>
        ...
        <div class="home-content">
            ...
            <div class="home-img" style="width: 500px;">
                ...
                onmouseout="this.start();">
                    <a href="#" style="color: white;">Addmission open of 13th August 2024, Stream IT, ECE, EEE and Computer Science.</a>
                    </marquee>
    ...
    <section class="services">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <font>ECE</font>
                <p>Electronics and Communication Engg.</p>
                <!--btn--------->
                <a href="#">Apply Now</a>
            </div>
            <!--box-2-------->
            ...
            <div class="box">
                <img src="images/icon5.png">
                <font>EEE</font>
                <p>Electrical and Electronics Engg.</p>
                <!--btn--------->
                <a href="#">Apply Now</a>
            </div>
            <!--box-4-------->
